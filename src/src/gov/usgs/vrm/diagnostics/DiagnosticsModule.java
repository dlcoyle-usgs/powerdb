...
//
    ...
    public static void main(String[] args) throws Exception {
        ...
        LogUtils.header("DiagnosticsModule: Starting ...");
        DiagnosticsModule diagnosticsModule = new DiagnosticsModule();
        logger.info("diagnosticsModule: object=[{}]", diagnosticsModule);
        diagnosticsModule.processDiagnosticsFile();
        //LogUtils.header("DiagnosticsTest: Finished");
        LogUtils.header("DiagnosticsModule: Finished");
    ...
    void processDiagnosticsFile() throws IOException {
        ...
        describeDiagnosticsPick(diagnostics);
