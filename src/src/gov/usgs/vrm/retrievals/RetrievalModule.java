...
import gov.usgs.vrm.history.HistoryParser;
...
public class RetrievalModule {
    ...
    public static void main(String args[]) throws IOException, InterruptedException, URISyntaxException {
        ...
        RetrievalModule retrievalModule = new RetrievalModule();
        retrievalModule.init();
        retrievalModule.sendGetRequest();
...
//        }
     ...
     */
    public void sendGetRequest() throws IOException, InterruptedException, URISyntaxException {
